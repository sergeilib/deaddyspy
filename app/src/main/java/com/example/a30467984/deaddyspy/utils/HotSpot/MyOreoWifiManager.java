...
public class MyOreoWifiManager {
    ...
    public MyOreoWifiManager(Context c) {
        ...
        mConnectivityManager = (ConnectivityManager) this.mContext.getApplicationContext().getSystemService(ConnectivityManager.class);
    }
    ...
    public boolean startTethering(final MyOnStartTetheringCallback callback) {
        ...
        File outputDir = this.mContext.getApplicationContext().getCodeCacheDir();
        Object proxy;
        try {
        ...
        try {
            ...
            if (method == null) {
                ...
                method.invoke(mConnectivityManager, ConnectivityManager.TYPE_WIFI , false, proxy, null);
